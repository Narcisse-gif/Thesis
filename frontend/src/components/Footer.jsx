  ...
  return (
    <footer className="bg-primary text-white border-t border-white/10 pt-12 pb-8 px-6 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="md:col-span-1">
          ...
          <p className="text-blue-100 text-sm leading-relaxed">
            La premiere plateforme de mise en relation entre etudiants et entreprises au
            Burkina Faso. Ensemble pour l&apos;excellence professionnelle.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-blue-100">
            <li><Link className="hover:text-white transition-colors" to="/conseils/article/maitriser-entretien-embauche">Conseils d&apos;entretien</Link></li>
            <li><Link className="hover:text-white transition-colors" to="/conseils/article/soft-skills-entreprises-burkina">Blog Carriere</Link></li>
            <li><Link className="hover:text-white transition-colors" to="/conseils/article/cv-impactant-burkina">Modeles de CV</Link></li>
            <li><Link className="hover:text-white transition-colors" to="/conseils/article/reussir-premier-stage">Success Stories</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-blue-200/60">
        <p>© 2026 StageLink Burkina Faso. Tous droits reserves.</p>
        <div className="flex gap-6">
          <Link className="hover:text-white transition-colors" to="/mentions-legales">Mentions legales</Link>
          <Link className="hover:text-white transition-colors" to="/confidentialite">Confidentialite</Link>
          <Link className="hover:text-white transition-colors" to="/cgu">CGU</Link>
        </div>
      </div>
    </footer>
  );
