...
export default function Navbar() {
  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 px-6 py-4 lg:px-20 bg-white dark:bg-background-dark sticky top-0 z-50">
      ...
      <div className="flex gap-3">
        ...
        <button onClick={() => navigate('/connexion')} className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-xl h-10 px-4 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-sm font-bold flex-shrink-0 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all">
          <span>Connexion</span>
        </button>
      </div>
    </header>
