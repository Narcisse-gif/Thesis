...
export default function InternshipDetailPage() {
  ...
  const { id } = useParams();
  const companyProfileByInternshipId = {
    '1': '1',
    '2': '2',
    '3': '3',
    '4': '4'
  };
  const companyProfileId = companyProfileByInternshipId[id] || '1';
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 py-8 sm:py-12">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-5 sm:gap-8 text-slate-600">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-extrabold text-primary uppercase text-[15px] tracking-wide">Coris Bank International</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-[14px] font-medium">
                    ...
                    <span>6 mois (Temps plein)</span>
                  </div>
                  <div className="flex items-center gap-2 text-[14px] font-bold text-slate-800">
                    <span className="material-symbols-outlined text-primary !text-[20px]">payments</span>
                    <span>Indemnite mensuelle + transport</span>
                  </div>
                </div>
              </div>

              <div className="hidden md:block">
                <div className="bg-amber-50 border border-amber-200/60 rounded-xl p-5 max-w-[260px] shadow-sm">
                  <p className="text-[11px] text-amber-800/80 font-black uppercase tracking-widest mb-1.5">Date limite</p>
                  <p className="text-[18px] font-black text-amber-900">30 / 04 / 2026</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-2 p-6 sm:p-10 lg:border-r border-slate-100 space-y-12">
              <section>
                ...
                <div className="text-slate-600 leading-relaxed space-y-4 text-[15px]">
                  <p>
                    Vous integrerez l'equipe Risque Credit de Coris Bank International a Ouagadougou pour contribuer a l'analyse des dossiers de financement des PME.
                    Ce stage est ideal pour un profil en finance qui souhaite gagner une experience pratique sur des cas reels du marche local.
                  </p>
                  <p>
                    Vous serez accompagne par un tuteur metier et participerez aux revues hebdomadaires de portefeuille, avec un fort accent sur la qualite d'analyse et la rigueur documentaire.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-4 text-[15px] text-slate-700 font-medium">
                    ...
                    <span>Collecter et structurer les pieces financieres des clients (bilans, comptes de resultat, flux).</span>
                  </li>
                  <li className="flex items-start gap-4 text-[15px] text-slate-700 font-medium">
                    <span className="material-symbols-outlined text-blue-500 mt-0.5 !text-[18px]">check_circle</span>
                    <span>Contribuer aux analyses de solvabilite et a la redaction de notes de synthese credit.</span>
                  </li>
                  <li className="flex items-start gap-4 text-[15px] text-slate-700 font-medium">
                    <span className="material-symbols-outlined text-blue-500 mt-0.5 !text-[18px]">check_circle</span>
                    <span>Mettre a jour les tableaux de suivi des engagements et participer au reporting mensuel.</span>
                  </li>
                  <li className="flex items-start gap-4 text-[15px] text-slate-700 font-medium">
                    <span className="material-symbols-outlined text-blue-500 mt-0.5 !text-[18px]">check_circle</span>
                    <span>Assister les analystes seniors lors des comites de validation internes.</span>
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="bg-slate-50 p-5 rounded-xl border border-slate-100">
                    ...
                    <p className="text-slate-600 text-[15px] ml-3.5">Bac + 3 a Bac + 5 en Finance, Comptabilite, Gestion ou Economie.</p>
                  </div>

                  <div className="bg-slate-50 p-5 rounded-xl border border-slate-100">
                    <h4 className="font-extrabold text-slate-900 text-[14px] mb-2 uppercase tracking-wide flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-slate-400"></span> Niveau attendu
                    </h4>
                    <p className="text-slate-600 text-[15px] ml-3.5">Stage de fin d'etudes ou stage professionnel avec une bonne maitrise d'Excel.</p>
                  </div>

                  <div className="bg-slate-50 p-5 rounded-xl border border-slate-100">
                    <h4 className="font-extrabold text-slate-900 text-[14px] mb-3 uppercase tracking-wide flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-slate-400"></span> Competences cle
                    </h4>
                    <ul className="space-y-2.5 text-[15px] text-slate-600 ml-3.5 list-disc pl-4 marker:text-slate-300">
                      <li>Analyse financiere de base et interpretation des ratios.</li>
                      <li>Aisance redactionnelle et capacite de synthese.</li>
                      <li>Sens de la confidentialite et rigueur professionnelle.</li>
                      <li>Bonne communication et esprit d'equipe.</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                    <p className="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-2">Methodes</p>
                    <p className="text-sm font-semibold text-slate-700">Processus de decision credit en environnement bancaire.</p>
                  </div>
                  <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                    <p className="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-2">Outils</p>
                    <p className="text-sm font-semibold text-slate-700">Modeles de scoring, tableaux de bord et reporting de portefeuille.</p>
                  </div>
                </div>
              </section>
              ...
              <div className="pt-8 border-t border-slate-100">
                <button
                  ...
                  onClick={() => navigate(`/postuler/${id || '1'}`)}
                >
            ...
            <div className="bg-slate-50/50 p-6 sm:p-10 space-y-10">
              <div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <h4 className="font-black text-slate-900 text-lg uppercase tracking-tight">Coris Bank International</h4>
                  <p className="text-[13px] font-bold text-slate-400 mt-1">Banque commerciale et corporate</p>

                  <p className="mt-5 text-[14px] text-slate-600 leading-relaxed font-medium">
                    Coris Bank International accompagne la croissance des entreprises et des talents locaux a travers des solutions financieres innovantes.
                  </p>
              ...
              <div className="border-t border-slate-200 pt-8">
                ...
                <div className="grid grid-cols-1 gap-3 text-left">
                  <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-primary/30 transition-colors cursor-default">
                    ...
                    <span className="text-[14px] font-bold text-slate-700">Demarrage: Mai 2026</span>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-primary/30 transition-colors cursor-default">
                    <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center text-primary">
                      <span className="material-symbols-outlined !text-[18px]">timer</span>
                    </div>
                    <span className="text-[14px] font-bold text-slate-700">Duree: 6 mois</span>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-primary/30 transition-colors cursor-default">
                    <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center text-primary">
                      <span className="material-symbols-outlined !text-[18px]">supervisor_account</span>
                    </div>
                    <span className="text-[14px] font-bold text-slate-700">Encadrement par un analyste senior</span>
                  </div>
                </div>
              </div>
        ...
        <section className="mt-16">
          <div className="flex items-center justify-between mb-8 border-b border-slate-200 pb-4">
            <h3 className="text-2xl font-bold text-slate-900">Stages similaires</h3>
            <button
              className="text-primary font-bold flex items-center gap-1 hover:gap-2 transition-all text-[14px]"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="group bg-white p-6 rounded-2xl border border-slate-200 hover:border-primary/30 hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer" onClick={() => navigate('/stages/2')}>
            ...
            <div className="group bg-white p-6 rounded-2xl border border-slate-200 hover:border-primary/30 hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer" onClick={() => navigate('/stages/3')}>
              <div className="flex items-center justify-between mb-5">
                <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center p-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest px-2.5 py-1 bg-blue-50/80 text-primary border border-blue-100 rounded-md">PFE</span>
              </div>
              <h4 className="font-bold text-[16px] text-slate-900 group-hover:text-primary transition-colors line-clamp-1">Stagiaire Ingenieur Reseaux</h4>
              <p className="text-[13px] font-medium text-slate-500 mt-1 mb-5">SONABEL</p>
              <div className="flex items-center justify-between text-[11px] font-bold text-slate-400 border-t border-slate-100 pt-4">
            ...
            <div className="group bg-white p-6 rounded-2xl border border-slate-200 hover:border-primary/30 hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer hidden md:block" onClick={() => navigate('/stages/4')}>
              <div className="flex items-center justify-between mb-5">
                <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center p-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest px-2.5 py-1 bg-slate-100 text-slate-600 border border-slate-200 rounded-md">Academique</span>
              </div>
              <h4 className="font-bold text-[16px] text-slate-900 group-hover:text-primary transition-colors line-clamp-1">Assistant Marketing Digital</h4>
              ...
              <div className="flex items-center justify-between text-[11px] font-bold text-slate-400 border-t border-slate-100 pt-4">
                ...
                <span className="text-primary">A l'instant</span>
              </div>
            </div>
          </div>
        </section>
