    ...
    <AdminDashboardLayout>
      <section className="space-y-8">
        <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-slate-900 mb-2">Notifications admin</h2>
            <p className="text-slate-500 text-sm">
              Suivez vos alertes de messagerie et les evenements importants de la console.
            </p>
          </div>
          <button
            type="button"
          ...
          {loading ? (
            ...
            <div className="px-6 py-16 text-center">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Les nouvelles alertes apparaitront ici automatiquement.
              </p>
            </div>
          ) : (
