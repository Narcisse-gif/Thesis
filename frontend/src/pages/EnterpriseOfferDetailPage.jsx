    ...
    <EnterpriseDashboardLayout>
      <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6 w-full">
        <div>
          ...
          <p className="text-slate-500 mt-1.5 text-[15px]">Toutes les informations renseignees pour cette offre.</p>
        </div>
        <div className="flex flex-wrap gap-3">
          ...
          <button
            onClick={() => navigate(`/entreprise/offres/nouvelle?edit=${id}`)}
            className="px-4 py-2 bg-blue-50 text-blue-700 text-[13px] border border-blue-100 font-bold rounded-xl flex items-center gap-2 hover:bg-blue-100 transition-colors shadow-sm"
          >
          ...
          <div className="p-8 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-50 rounded-2xl border border-slate-100 p-5">
                ...
                <p className="text-[16px] font-bold text-slate-900 mt-2">{formatAmount(offer.salaryOrStipend)}</p>
              </div>
            </div>
                ...
                <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
                  ...
                  <div className="space-y-3 text-[13px] text-slate-600">
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <span className="font-semibold text-slate-800">{offer.applications?.length || 0}</span>
                    </div>
                  </div>
                </div>
